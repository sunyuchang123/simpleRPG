 ...
 * @author yucha
 */
public class SimpleRPG extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SimpleRPG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
