 ...
 * @author yucha
 */
public class BattleMap3 extends javax.swing.JFrame {

    /**
     * Creates new form BattleMap3
     */
    public BattleMap3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setName("Ocean"); // NOI18N
        label1.setText("Ocean");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BattleMap3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BattleMap3().setVisible(true);
            }
        });
    }
